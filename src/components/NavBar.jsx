...
const NavBar = () => {
  ...
  const Links =({name})=> <li className={classN(name)}><NavLink style={{textDecoration: 'none',textTransform: 'uppercase'}} end to={name}>{name}</NavLink></li>
  const svgs =  <svg width="40" height="40" viewBox="0 0 100 100">
